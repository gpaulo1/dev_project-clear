...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "net.com.dev_web.controller" })
public class ApplicationContext extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registy) {
		...
		registy.addResourceHandler("/js/**").addResourceLocations("/js/");
		registy.addResourceHandler("/css/**").addResourceLocations("/css/");
		registy.addResourceHandler("/images/**").addResourceLocations("/images/");
		registy.addResourceHandler("/resources/**").addResourceLocations("/resources/");
	}
